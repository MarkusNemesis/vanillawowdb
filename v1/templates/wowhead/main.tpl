...
{literal}
		...
		.news { position: relative; text-align: left; width: 519px; height: 512px; margin: 30px auto 0 auto; background: url(templates/wowhead/images/mainpage-bg-news-{/literal}{$language}{literal}.jpg) no-repeat }
